...
```
### Типы данных:
В джс принято следующее определение типа:
...
Значение 42 имеет встроенный тип number, и этот тип не может быть изменён. Другое значение, например, "42" с типом string, может быть получено из значения 42 типа number с помощью приведения типов.
